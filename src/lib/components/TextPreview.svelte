<script lang="ts">
	...
	let { name, degree, position, timePosted, text }: Props = $props();
...
<div class="flex flex-col bg-white post-container shadow-sm rounded-md m-auto my-4">
	<div class="px-4 pt-3 mb-2 flex items-center">
		...
		<div class="flex-1 p-[2px] ml-3 cursor-pointer flex justify-between">
			...
			<button
				class="ml-auto p-1 text-gray-400 hover:text-gray-600 rounded-full h-fit hover:bg-gray-200 transition-colors"
				aria-label="More"
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
